...
namespace RestaurantsDAB.Controllers.AllRestaurants
{
    public class RestaurantsController : Controller
    {
        ...
        {
            var DbContext = _context.Restaurants.Include(r => r.Reviews);
        ...
        public async Task<IActionResult> Create([Bind("Name,Type,Address,RestaurantID")] Restaurant restaurant)
        {
